...
function Logo() {
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: _Logo_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].glitch
  }, "BANG", /*#__PURE__*/React.createElement("span", null), /*#__PURE__*/React.createElement("span", null)));
}
...
___CSS_LOADER_EXPORT___.push([module.id, `.EDeinQzfS2N2rVW_Z1GP {
  ...
  align-items: center;
  background-color: rgb(17, 41, 56);
  color: white;
  border-radius: 2vmin;
  font-size: 2.7vmin;
  font-family: "VT323-Regular";
  border: 0.6vmin solid #F07A0F;
  position: relative;
  text-shadow: 0.05em 0 0 rgba(236, 98, 80, 0.75), -0.025em -0.05em 0 rgba(250, 171, 75, 0.75), 0.025em 0.05em 0 rgba(17, 41, 56, 0.75);
  /* https://web.dev/prefers-reduced-motion/#(bonus)-forcing-reduced-motion-on-all-websites */
}
.EDeinQzfS2N2rVW_Z1GP .hOy9h3_XTviVFUkh6iIK {
  font-size: 3rem;
  font-weight: 700;
  text-transform: uppercase;
  position: relative;
  animation: hOy9h3_XTviVFUkh6iIK 500ms infinite;
}
.EDeinQzfS2N2rVW_Z1GP .hOy9h3_XTviVFUkh6iIK span {
  position: relative;
  top: 100;
  left: 0;
  color: red;
  z-index: 1;
  -webkit-clip-path: polygon(21% 19%, 0 64%, 100% 68%);
  clip-path: polygon(21% 19%, 0 64%, 100% 68%);
  transform: translate(-1.55em, -0.05em);
  color: green;
  opacity: 0.8;
}
.EDeinQzfS2N2rVW_Z1GP .EDeinQzfS2N2rVW_Z1GP .hOy9h3_XTviVFUkh6iIK span:first-child {
  animation: hOy9h3_XTviVFUkh6iIK 200ms infinite;
  color: red;
  z-index: 1;
  -webkit-clip-path: polygon(21% 19%, 0 64%, 100% 68%);
  clip-path: polygon(21% 19%, 0 64%, 100% 68%);
...
.EDeinQzfS2N2rVW_Z1GP .hOy9h3_XTviVFUkh6iIK span:last-child {
  animation: hOy9h3_XTviVFUkh6iIK 1375ms infinite;
  color: red;
  z-index: 1;
  -webkit-clip-path: polygon(0 47%, 35% 95%, 99% 0);
  clip-path: polygon(0 47%, 35% 95%, 99% 0);
  transform: translate(1.5em, 2.025em);
  /* color: red; */
  opacity: 0.8;
}
@keyframes hOy9h3_XTviVFUkh6iIK {
  0% {
    text-shadow: 0.05em 0 0 rgba(236, 98, 80, 0.75), -0.05em -0.025em 0 rgba(250, 171, 75, 0.75), -0.025em 0.05em 0 rgba(17, 41, 56, 0.75);
  }
  14% {
    text-shadow: 0.05em 0 0 rgba(236, 98, 80, 0.75), -0.05em -0.025em 0 rgba(250, 171, 75, 0.75), -0.025em 0.05em 0 rgba(17, 41, 56, 0.75);
  }
  15% {
    text-shadow: -0.05em -0.025em 0 rgba(236, 98, 80, 0.75), 0.025em 0.025em 0 rgba(250, 171, 75, 0.75), -0.05em -0.05em 0 rgba(17, 41, 56, 0.75);
  }
  49% {
    text-shadow: -0.05em -0.025em 0 rgba(236, 98, 80, 0.75), 0.025em 0.025em 0 rgba(250, 171, 75, 0.75), -0.05em -0.05em 0 rgba(17, 41, 56, 0.75);
  }
  50% {
    text-shadow: 0.025em 0.05em 0 rgba(236, 98, 80, 0.75), 0.05em 0 0 rgba(250, 171, 75, 0.75), 0 -0.05em 0 rgba(17, 41, 56, 0.75);
  }
  99% {
    text-shadow: 0.025em 0.05em 0 rgba(236, 98, 80, 0.75), 0.05em 0 0 rgba(250, 171, 75, 0.75), 0 -0.05em 0 rgba(17, 41, 56, 0.75);
  }
  100% {
    text-shadow: -0.025em 0 0 rgba(236, 98, 80, 0.75), -0.025em -0.025em 0 rgba(250, 171, 75, 0.75), -0.025em -0.05em 0 rgba(17, 41, 56, 0.75);
  }
}`, "",{"version":3,"sources":["webpack://./src/components/Logo/Logo.module.scss"],"names":[],"mappings":"AACA;EACI,cAAA;EACA,aAAA;EACA,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;EACA,iCAAA;EACA,YAAA;EACA,oBAAA;EAEA,kBAAA;EACA,4BAAA;EACA,6BAAA;EACA,kBAAA;EAWF,qIACE;EAuCF,2FAAA;AAlDF;AAEE;EACE,eAAA;EACA,gBAAA;EACA,yBAAA;EACA,kBAAA;EAEA,8CAAA;AADJ;AAQE;EACE,kBAAA;EACA,QAAA;EACA,OAAA;EACC,UAAA;EACD,UAAA;EACA,oDAAA;EACQ,4CAAA;EACR,sCAAA;EACA,YAAA;EACA,YAAA;AANJ;AASE;EACE,8CAAA;EACA,UAAA;EACA,UAAA;EACA,oDAAA;EACQ,4CAAA;EACR,sCAAA;EACA,YAAA;EACA,YAAA;AAPJ;AAUE;EACE,+CAAA;EACA,UAAA;EACA,UAAA;EACA,iDAAA;EACQ,yCAAA;EACR,oCAAA;EACA,gBAAA;EACA,YAAA;AARJ;AAaE;EACE;IACE,sIAAA;EAXJ;EAeE;IACE,sIAAA;EAbJ;EAiBE;IACE,6IAAA;EAfJ;EAmBE;IACE,6IAAA;EAjBJ;EAqBE;IACE,8HAAA;EAnBJ;EAsBE;IACE,8HAAA;EApBJ;EAuBE;IACE,0IAAA;EArBJ;AACF","sourcesContent":["\n.Logo {\n    height: 12vmin;\n    width: 28vmin;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    background-color: rgba(17,41,56);\n    color: white;\n    border-radius: 2vmin;\n  \n    font-size: 2.7vmin;\n    font-family: 'VT323-Regular';\n    border: .6vmin solid #F07A0F;\n    position: relative; // Needed to make sure the glitched spans are placed correctly\n    \n  \n  .glitch {\n    font-size: 3rem;\n    font-weight: 700;\n    text-transform: uppercase;\n    position: relative;\n  \n    animation: glitch 500ms infinite;\n  }\n  text-shadow: \n    0.05em 0 0 rgba(236,98,80,0.75),   \n    -0.025em -0.05em 0 rgba(250, 171, 75,0.75),\n    0.025em 0.05em 0 rgba(17,41,56,0.75);\n  \n  .glitch span {\n    position: relative;\n    top: 100;\n    left: 0;\n     color: red;\n    z-index: 1;\n    -webkit-clip-path: polygon(21% 19%, 0 64%, 100% 68%);\n            clip-path: polygon(21% 19%, 0 64%, 100% 68%);\n    transform: translate(-1.55em, -0.05em);\n    color: green;\n    opacity: 0.8;\n  }\n  \n  .Logo .glitch span:first-child {\n    animation: glitch 200ms infinite;\n    color: red;\n    z-index: 1;\n    -webkit-clip-path: polygon(21% 19%, 0 64%, 100% 68%);\n            clip-path: polygon(21% 19%, 0 64%, 100% 68%);\n    transform: translate(-1.55em, -0.05em);\n    color: green;\n    opacity: 0.8;\n  }\n  \n  .glitch span:last-child {\n    animation: glitch 1375ms infinite;\n    color: red;\n    z-index: 1;\n    -webkit-clip-path: polygon(0 47%, 35% 95%, 99% 0);\n            clip-path: polygon(0 47%, 35% 95%, 99% 0);\n    transform: translate(1.5em, 2.025em);\n    /* color: red; */\n    opacity: 0.8;\n  }\n  \n  /* https://web.dev/prefers-reduced-motion/#(bonus)-forcing-reduced-motion-on-all-websites */\n  \n  @keyframes glitch {\n    0% {\n      text-shadow: 0.05em 0 0 rgba(236,98,80,0.75),\n        -0.05em -0.025em 0 rgba(250, 171, 75,0.75),\n        -0.025em 0.05em 0 rgba(17,41,56,0.75);\n    }\n    14% {\n      text-shadow: 0.05em 0 0 rgba(236,98,80,0.75),\n        -0.05em -0.025em 0 rgba(250, 171, 75,0.75),\n        -0.025em 0.05em 0 rgba(17,41,56,0.75);\n    }\n    15% {\n      text-shadow: -0.05em -0.025em 0 rgba(236,98,80,0.75),\n        0.025em 0.025em 0 rgba(250, 171, 75,0.75),\n        -0.05em -0.05em 0 rgba(17,41,56,0.75);\n    }\n    49% {\n      text-shadow: -0.05em -0.025em 0 rgba(236,98,80,0.75),\n        0.025em 0.025em 0 rgba(250, 171, 75,0.75),\n        -0.05em -0.05em 0 rgba(17,41,56,0.75);\n    }\n    50% {\n      text-shadow: 0.025em 0.05em 0 rgba(236,98,80,0.75),\n        0.05em 0 0 rgba(250, 171, 75,0.75), 0 -0.05em 0 rgba(17,41,56,0.75);\n    }\n    99% {\n      text-shadow: 0.025em 0.05em 0 rgba(236,98,80,0.75),\n        0.05em 0 0 rgba(250, 171, 75,0.75), 0 -0.05em 0 rgba(17,41,56,0.75);\n    }\n    100% {\n      text-shadow: -0.025em 0 0 rgba(236,98,80,0.75),\n        -0.025em -0.025em 0 rgba(250, 171, 75,0.75),\n        -0.025em -0.05em 0 rgba(17,41,56,0.75);\n    }\n  }\n  \n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"Logo": `EDeinQzfS2N2rVW_Z1GP`,
	"glitch": `hOy9h3_XTviVFUkh6iIK`
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
___CSS_LOADER_EXPORT___.push([module.id, `.eBz5FvD9TgyIgfFi1MdG {
  background-color: var(--white);
  border: 0.9vmin solid var(--washred);
  border-radius: 2.1vmin;
  margin: 3vmin 0;
  padding: 3vmin;
}`, "",{"version":3,"sources":["webpack://./src/components/MenuList/MenuList.module.scss"],"names":[],"mappings":"AAAA;EACI,8BAAA;EACA,oCAAA;EACA,sBAAA;EACA,eAAA;EACA,cAAA;AACJ","sourcesContent":[".MenuList {\n    background-color: var(--white);\n    border: .9vmin solid var(--washred);\n    border-radius: 2.1vmin;\n    margin: 3vmin 0;\n    padding: 3vmin;\n    }"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
___CSS_LOADER_EXPORT___.push([module.id, `.X4tFBfG4MKknHvd01CKE {
  ...
  padding: 2vmin;
  color: var(--text-light);
  background-color: var(--washred);
  border: 0.3vmin solid var(--tan-3);
  border-radius: 1vmin;
  font-size: 4vmin;
}
...
.X4tFBfG4MKknHvd01CKE .VR1OCl60qOXrRx1IzVEa {
  ...
  text-align: center;
  color: var(--text-light);
}`, "",{"version":3,"sources":["webpack://./src/components/MenuListItem/MenuListItem.module.scss"],"names":[],"mappings":"AAAA;EACE,WAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,oBAAA;EACA,cAAA;EACA,wBAAA;EACA,gCAAA;EACA,kCAAA;EACA,oBAAA;EACA,gBAAA;AACF;;AAEA;EACE,WAAA;EACA,UAAA;EACA,cAAA;EACA,8BAAA;EACA,kCAAA;EACA,oBAAA;AACF;;AAEA;EACE,aAAA;EACA,sBAAA;AACF;;AAEA;EACE,gBAAA;EACA,kBAAA;EACA,wBAAA;AACF;;AAEA;EACE,cAAA;EACA,kBAAA;EACA,wBAAA;AACF","sourcesContent":[".MenuListItem {\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 3vmin;\n  padding: 2vmin;\n  color: var(--text-light);\n  background-color: var(--washred);\n  border: .3vmin solid var(--tan-3);\n  border-radius: 1vmin;\n  font-size: 4vmin;\n}\n\n.MenuListItem .emoji {\n  height: 8vw;\n  width: 8vw;\n  font-size: 4vw;\n  background-color: var(--white);\n  border: .1vmin solid var(--tan-3);\n  border-radius: 1vmin;\n}\n\n.MenuListItem .buy {\n  display: flex;\n  flex-direction: column;\n}\n\n.MenuListItem .buy span {\n  font-size: 1.7vw;\n  text-align: center;\n  color: var(--text-light);\n}\n\n.MenuListItem .name {\n  font-size: 2vw;\n  text-align: center;\n  color: var(--text-light);\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
.cPR75kdAXDGVxib0PszB .dyrUhYTujwEUiMzpjxWX {
  ...
  top: 50vh;
  font-size: 2vmin;
}`, "",{"version":3,"sources":["webpack://./src/components/OrderDetail/OrderDetail.module.scss"],"names":[],"mappings":"AAAA;EACE,sBAAA;EACA,2BAAA;EACA,mBAAA;EACA,cAAA;EACA,gBAAA;EACA,wBAAA;EACA,oCAAA;EACA,eAAA;EACA,oBAAA;AACF;;AAGA;EACE,WAAA;AAAF;;AAGA;EACE,iBAAA;EACA,2BAAA;EACA,4BAAA;EACA,WAAA;AAAF;;AAGA;EACE,WAAA;EACA,aAAA;EACA,4CAAA;EACA,gBAAA;EACA,wBAAA;EACA,sCAAA;AAAF;;AAGA;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,gBAAA;EACA,wBAAA;AAAF;;AAGA;EACE,aAAA;EACA,yBAAA;AAAF;;AAGA;EACE,kBAAA;EACA,SAAA;EACA,gBAAA;AAAF","sourcesContent":[".OrderDetail {\n  flex-direction: column;\n  justify-content: flex-start;\n  align-items: center;\n  padding: 3vmin;\n  font-size: 2vmin;\n  color: var(--text-light);\n  border: .9vmin solid var(--washred);\n  margin: 3vmin 0;\n  border-radius: 2vmin;\n  \n}\n\n.OrderDetail .sectionHeading {\n  width: 100%\n}\n\n.OrderDetail .lineItemContainer {\n  margin-top: 3vmin;\n  justify-content: flex-start;\n  height: calc(100vh - 18vmin);\n  width: 100%;\n}\n\n.OrderDetail .total {\n  width: 100%;\n  display: grid;\n  grid-template-columns: 18.35vw 5.75vw 5.25vw;\n  padding: 1vmin 0;\n  color: var(--text-light);\n  border-top: .1vmin solid var(--tan-3);\n}\n\n.OrderDetail .total span {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  font-size: 1.5vw;\n  color: var(--text-white);\n}\n\n.OrderDetail .total span.right {\n  display: flex;\n  justify-content: flex-end;\n}\n\n.OrderDetail .hungry {\n  position: absolute;\n  top: 50vh;\n  font-size: 2vmin;\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
.l6Ner7C7O5I4V69HVVgW .zqVYKU3SzotKremHzxQ_ {
  ...
  position: absolute;
  top: 50vh;
}`, "",{"version":3,"sources":["webpack://./src/components/OrderList/OrderList.module.scss"],"names":[],"mappings":"AAAA;EACI,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,8BAAA;EACA,oCAAA;EACA,sBAAA;EACA,eAAA;EACA,cAAA;AACJ;;AAEI;EACA,wBAAA;EACA,gBAAA;EACA,kBAAA;EACA,SAAA;AACJ","sourcesContent":[".OrderList {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    background-color: var(--white);\n    border: .9vmin solid var(--washred);\n    border-radius: 2.1vmin;\n    margin: 3vmin 0;\n    padding: 3vmin;\n    }\n    \n    .OrderList .noOrders {\n    color: var(--text-light);\n    font-size: 2vmin;\n    position: absolute;\n    top: calc(50vh);\n    }"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
___CSS_LOADER_EXPORT___.push([module.id, `.RygkJgZmBHTETlLP3C3i {
  ...
  align-items: center;
  background-image: url("https://i.pinimg.com/originals/c1/d2/e5/c1d2e5b38e1d38dbc2621f157465ce71.gif");
...
.RygkJgZmBHTETlLP3C3i h3 {
  ...
  text-transform: uppercase;
  font-weight: bold;
}`, "",{"version":3,"sources":["webpack://./src/pages/AuthPage/AuthPage.module.scss"],"names":[],"mappings":"AACA;EACE,aAAA;EACA,aAAA;EACA,6BAAA;EACA,mBAAA;EACA,qGAAA;EACA,4BAAA;EACA,2BAAA;EACA,sBAAA;AAAF;;AAGA;EAEE,mBAAA;EACA,kBAAA;EACA,eAAA;EACA,kBAAA;EACA,uCAAA;EACA,cAAA;EACA,yBAAA;EACA,iBAAA;AADF","sourcesContent":["\n.AuthPage {\n  height: 100vh;\n  display: flex;\n  justify-content: space-evenly;\n  align-items: center;\n  background-image: url('https://i.pinimg.com/originals/c1/d2/e5/c1d2e5b38e1d38dbc2621f157465ce71.gif');\n  background-repeat: no-repeat;\n  background-position: center;\n  background-size:cover;\n}\n\n.AuthPage h3 {\n  \n  margin-top: 2.7vmin;\n  text-align: center;\n  cursor: pointer;\n  font-size: 2.7vmin;\n  font-family: 'VT323-Regular', monospace;\n  color: #FFFFFF;\n  text-transform: uppercase;\n  font-weight: bold;\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
___CSS_LOADER_EXPORT___.push([module.id, `.t28KGTGNA2Wz6K9neu4g {
  ...
  width: 100%;
  display: cover;
}`, "",{"version":3,"sources":["webpack://./src/router/AppRouter.module.scss"],"names":[],"mappings":"AAAA;EACI,YAAA;EACA,WAAA;EACA,cAAA;AACJ","sourcesContent":[".App {\n    height: 100%;\n    width: 100%;\n    display: cover;\n  }"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
